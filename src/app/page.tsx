  ...
  return (
    <div className="relative space-y-5">
      <section className="flex flex-col items-center justify-center gap-4 pt-16">
        ...
        <div className="absolute right-5 top-5 flex h-8 w-8 items-center justify-center rounded-full bg-white shadow-md duration-300 hover:scale-110 hover:shadow-lg hover:ease-in-out dark:bg-white">
