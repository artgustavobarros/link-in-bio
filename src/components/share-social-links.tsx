...
export function ShareSocialLinks({ url }: ShareSocialLinksProps) {
  return (
    <>
      ...
      <Dialog.Content className="fixed left-[50%] top-[50%] max-h-[85vh] w-[90vw] max-w-[450px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-white p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none data-[state=open]:animate-contentShow dark:bg-white">
        ...
        <section className="space-y-4">
          <div className="flex h-12 items-center rounded-2xl p-6 duration-300 hover:bg-zinc-200 dark:hover:bg-zinc-200">
